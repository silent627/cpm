...
CREATE TABLE `config_info` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_configinfo_datagrouptenant` (`data_id`(191),`group_id`(191),`tenant_id`(128))
...
CREATE TABLE `config_info_aggr` (
  ...
  `tenant_id` varchar(128) DEFAULT '' COMMENT '租户字段',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_configinfoaggr_datagrouptenantdatum` (`data_id`(191),`group_id`(191),`tenant_id`(128),`datum_id`(191))
...
CREATE TABLE `config_info_beta` (
  ...
  `encrypted_data_key` text NOT NULL COMMENT '秘钥',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_configinfobeta_datagrouptenant` (`data_id`(191),`group_id`(128),`tenant_id`(128))
...
CREATE TABLE `config_info_tag` (
  ...
  `src_ip` varchar(50) DEFAULT NULL COMMENT 'source ip',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_configinfotag_datagrouptenanttag` (`data_id`(191),`group_id`(128),`tenant_id`(128),`tag_id`(128))
...
CREATE TABLE `group_capacity` (
  ...
  `max_size` int(10) NOT NULL DEFAULT '0' COMMENT '最大单个文件大小，单位为字节，0表示使用默认值',
  `max_aggr_count` int(10) NOT NULL DEFAULT '0' COMMENT '最大聚合子配置个数，0表示使用默认值',
  `max_aggr_size` int(10) NOT NULL DEFAULT '0' COMMENT '最大聚合子配置大小，单位为字节，0表示使用默认值',
